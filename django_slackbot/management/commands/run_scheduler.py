...
from django_slackbot.chat import tab
...
class Command(BaseCommand):
    ...
    def run_pending(self, executor: ThreadPoolExecutor, **kwargs: Any) -> Iterator[int]:
    ...
    def run_scheduler(self, executor: ThreadPoolExecutor, timeout: int = -1, **kwargs: Any) -> Iterator[int]:
